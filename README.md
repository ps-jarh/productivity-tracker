...
A beautiful personal productivity tracker with AI coaching, daily journaling, target tracking, and smart weekly planning powered by Gemini.
...
Then add `VITE_GEMINI_API_KEY` in your Vercel project dashboard under **Settings → Environment Variables**.
...
- **React 18** + **Vite**
- **Claude (gemini-2.0-flash)** via Anthropic API
