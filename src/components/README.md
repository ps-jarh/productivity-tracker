...
A beautiful personal productivity tracker with AI coaching, daily journaling, target tracking, and smart weekly planning powered by Groq.
...
Then add `VITE_GROQ_API_KEY` in your Vercel project dashboard under **Settings → Environment Variables**.
